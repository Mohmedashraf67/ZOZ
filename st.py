...
raw = [
    ...
    ["Defect Rate","June","Rectangular Duct",2.26,1.99,2.28,2.56,2.11,1.95,2.65,2.21,1.83,1.79,2.2,0.5],
    ["Defect Rate","June","Circular Duct",1.65,2.11,2.26,1.93,1.61,1.89,2.45,2.03,2.42,2.32,2.0,0.5],
    ["Defect Rate","June","Diffuser",1.66,2.3,2.26,2.13,1.89,2.23,1.75,2.04,2.06,2.51,2.1,0.5],
    ["Defect Rate","June","Grille",2.24,1.69,1.9,1.61,2.27,2.23,1.72,2.03,2,1.59,1.9,0.5],
    ...
    ["Lead Time","June","Rectangular Duct",167.22,166.84,166.14,160,162.87,160.42,162.11,159.03,161.91,167.37,163,5],
    ["Lead Time","June","Circular Duct",168.62,176.09,171.35,170.89,178.59,179.13,172.8,175.15,167.03,169.07,172,8],
    ["Lead Time","June","Diffuser",69.53,67.43,67.23,68.34,64.61,67.45,67.02,68.9,65.15,69.49,67,3],
    ["Lead Time","June","Grille",67.98,68.74,71.68,72.26,69.09,68.26,73.81,69.17,71.68,71.86,71,4],
    ...
    ["Downtime","June","Rectangular Duct",9.97,10.57,9.68,10.06,5.43,9.28,7.09,10.33,9.63,9.97,8.0,3.0],
    ["Downtime","June","Circular Duct",6.12,4.16,6.03,3.59,6.34,6.29,4,6.14,4.86,4.3,5.0,2.0],
    ["Downtime","June","Diffuser",3.53,2.51,2.14,2.45,2.69,3.66,3.84,2.6,3.25,2.82,3.0,1.0],
    ["Downtime","June","Grille",3.87,3.07,3.79,2.31,3.85,2.42,3.83,2.58,2.3,2.88,3.0,1.0],
    ...
    ["OEE","June","Rectangular Duct",75.6,76.76,75.34,76.62,76.41,75.41,75.79,75.02,76.19,75.17,75,2],
    ["OEE","June","Circular Duct",76.43,75.88,74.91,74.13,74.09,75.5,75.96,75.08,75.46,74.19,75,2],
    ["OEE","June","Diffuser",73.48,74.23,74.18,74.35,75.14,73.7,74.03,75.7,75.74,73.43,75,2],
    ["OEE","June","Grille",74.67,75.15,74.7,73.94,74.71,76.46,75.3,75.7,76.28,75.96,75,2],
]
...
month_colors = {"April": "#43A047", "May": "#FB8C00", "June": "#1E88E5"}
...
show_april = fc1.checkbox("April", value=True)
show_may   = fc2.checkbox("May",   value=True)
show_june  = fc3.checkbox("June",  value=True)

sel_months = [m for m, v in zip(month_order, [show_april, show_may, show_june]) if v]
if not sel_months:
